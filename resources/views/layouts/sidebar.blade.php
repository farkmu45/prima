<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
			<aside class="app-sidebar doc-sidebar">
				<ul class="side-menu">
					<li class="slide">
						<a class="side-menu__item" href="/admin/dashboard"><i class="side-menu__icon fa fa-pie-chart"></i><span class="side-menu__label">Dashboard</span></a>
					</li>
					<li class="slide">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i
								class="side-menu__icon fa fa-money"></i><span class="side-menu__label">Payments</span><i
								class="angle fa fa-angle-right"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i
								class="side-menu__icon fa fa-users"></i><span class="side-menu__label">Referral</span><i
								class="angle fa fa-angle-right"></i></a>
						<ul class="slide-menu">
